// Iconos SVG originales (evitan depender de emoji gen̩ricos).
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 40 40" fill="none" aria-hidden="true">
      ...
      <path
        ...
        fill="none"
      />
      <path d="M25 11 H31 V17" stroke="#94a3b8" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" fill="none" />
      <circle cx="9" cy="26" r="2.6" fill="#94a3b8" />
    </svg>
  );
}
...
export function ScanIcon() {
  return (
    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
      <rect x="3" y="3" width="10" height="3" rx="1.5" fill="#14b8a6" />
      <rect x="3" y="3" width="3" height="10" rx="1.5" fill="#14b8a6" />
      <rect x="27" y="3" width="10" height="3" rx="1.5" fill="#14b8a6" />
      <rect x="34" y="3" width="3" height="10" rx="1.5" fill="#14b8a6" />
      <rect x="3" y="34" width="10" height="3" rx="1.5" fill="#14b8a6" />
      <rect x="3" y="27" width="3" height="10" rx="1.5" fill="#14b8a6" />
      <rect x="27" y="34" width="10" height="3" rx="1.5" fill="#14b8a6" />
      <rect x="34" y="27" width="3" height="10" rx="1.5" fill="#14b8a6" />
      <rect x="9" y="14" width="22" height="14" rx="2" fill="#e6fbf7" stroke="#2dd9b9" strokeWidth="1.5" />
      <line x1="12" y1="18" x2="28" y2="18" stroke="#2dd9b9" strokeWidth="2" strokeLinecap="round" />
      <line x1="12" y1="22" x2="22" y2="22" stroke="#2dd9b9" strokeWidth="2" strokeLinecap="round" />
      <line x1="3" y1="20.5" x2="37" y2="20.5" stroke="#94a3b8" strokeWidth="1.5" />
    </svg>
  );
}
...
export function MLIcon() {
  return (
    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
      ...
      <circle cx="10" cy="20" r="4" fill="#2dd9b9" />
      <circle cx="10" cy="30" r="4" fill="#14b8a6" />
      <circle cx="30" cy="15" r="4" fill="#94a3b8" />
      <circle cx="30" cy="25" r="4" fill="#94a3b8" />
      <path
...
export function ChatIcon() {
  return (
    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
      <rect x="4" y="7" width="26" height="19" rx="6" fill="#14b8a6" />
      <path d="M12 26 L9 33 L18 26 Z" fill="#14b8a6" />
...
export function SearchIcon() {
  return (
    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
      <circle cx="17" cy="17" r="11" fill="none" stroke="#14b8a6" strokeWidth="3.5" />
      <line x1="25" y1="25" x2="35" y2="35" stroke="#0b1120" strokeWidth="3.5" strokeLinecap="round" />
      <path d="M11 18 L15 12 L19 16 L24 9" stroke="#94a3b8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none" />
    </svg>
  );
}
